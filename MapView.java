...
public class MapView extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng pos = new LatLng(46.021385, 11.124158);
    ...
    public void notifyPhoneFound(String droneID) {
        ...
        a_builder.setMessage(droneID+" has found the buried person.")
                .setCancelable(false)
            ...
            public void run() {
                ...
                if (id.equals(SocketManager.DRONE1_ID)) {
                    ...
                    drone1 = mMap.addMarker(new MarkerOptions()
                            ...
                            .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
                    */
                    animateMarker(drone1, drone_pos);
                }
                else if (id.equals(SocketManager.DRONE2_ID)) {
                    animateMarker(drone2, drone_pos);
                    ...
                    drone2 = mMap.addMarker(new MarkerOptions()
                            ...
                            .title(SocketManager.DRONE2_ID)
                            .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)));*/
                    //mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(drone_pos, 13.2f));
                }
            }
        });
    }
    ...
    public void updatePhonePosition(double latitude, double longitude, double accuracy) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                animateMarker(phone, phone_pos);
            }
        });
    }

    public void animateMarker(Marker mrk, LatLng newPos){
        final Marker marker = mrk;
        double[] startValues = new double[]{marker.getPosition().latitude, marker.getPosition().longitude};
        double[] endValues = new double[]{newPos.latitude, newPos.longitude};
